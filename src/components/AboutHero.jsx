      ...
      <div className="w-[390px] md:w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center ">
        ...
        <div className="text-center mb-12 md:w-[882px] w-[314px] mx-auto">
          <h1 className="text-[32px] md:text-[40px] font-[700] mb-4">
            ...
            <span style={{ color: "rgba(7, 24, 86, 1)" }}>
              Meezak Technologies
            </span>
          </h1>
          <p
          ...
          >
            Meezak Technologies is a registered startup IT Consulting Company
            registered in Nigeria, West Africa but operating globally with the
            majority of our clients located in Europe, the United States,
            Australia, and the United Kingdom. Our Core aim is focused on
            developing solutions that are the best fit for the business
            requirements of our clients. We are committed to delivering quality
            and outstanding solutions to increase our client’s business value.
          </p>
        </div>

        {/* Image and Card Section */}
        <div className=" mx-auto flex w-[314px] md:w-full flex-col-reverse md:flex-row gap-4 items-center justify-center">
          {/* Image */}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(247.14deg, #061345 0%, #071856 100%)",
            }}
          >
            ...
            <div>
              <p className="text-[14px] font-[400] md:text-base text-gray-300">
                Our Core aim is focused on developing solutions that are the
                best fit for the business requirements of our clients. We are
                committed to delivering quality and outstanding solutions to
                increase our client’s business value.
              </p>
            </div>
          </div>
        </div>
