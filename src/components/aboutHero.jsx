  ...
  return (
    <section className=" bg-white py-16 md:pt-40 pt-32">
      <div className="w-[390px] md:w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center ">
        ...
        <div className="text-center mb-12 md:w-[882px] w-[314px] ">
          <h1 className="text-[32px] md:text-[40px] font-[700] mb-4">
            <span className="text-[rgba(204,90,113,1)]">Welcome to</span>{' '}
            <span className="text-[rgba(7,24,86,1)]">Meezak Technologies</span>
          </h1>
          <p className="text-[14px] w-[310px] md:w-full md:text-[14px] md:font-[400] md:text-[rgba(7, 24, 86, 1)];
 max-w-3xl mx-auto">
